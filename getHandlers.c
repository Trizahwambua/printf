...
/**
 * write_num - write a no using a bufffer
 * @ind:  - index at which the no starts on the buffer
 * @buffer: - buffer
 * @flags:  - flags
 * @width: - width
 * @prec: - precision spec
...
/**
 * write_unsgnd - writes an unsigned no
 * @is_negative: - no indicating if the no is negative
 * @ind: - index at which the no starts in the buffer
...
/**
 * write_pointer - writes a mem address
